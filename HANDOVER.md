...
- **当前 SHA-256**：`f25dc833a0859061b6b18d66e174a291918588deb6c4ae13f41d55871a37c280`。
...
```
产物输出在 `release/OLT Manager-1.1.6-win7-x64.zip`。

### 3.2 macOS Apple Silicon 版本
- **构建命令**：`pnpm run dist:mac`
- **产物位置**：`release/OLT Manager-1.1.6-arm64.dmg`
- **绕过“已损坏”安全提示**：
...
3. 点击 **同步 NMSE-PON (BOSS增量)**：
   - 系统自动从上次成功 Watermark 起拉取最新厚街增量工单。
   - 自动完成新装开机、过时端口置换、同客户更正与销户标记。
4. 点击 **手动合并**：
